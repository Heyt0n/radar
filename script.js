// ============================================================================
// 📡 RADAR CARBURANT - ENGINE TACTIQUE MULTI-PAYS (FR, DE, CH, BE, IT, ES)
// ============================================================================

// --- 0. INITIALISATION ET ÉTAT GLOBAL ---
...
function extraireVraiNom(station) {
    ...
    else if (adresseMinuscule.includes("repsol")) marque = "Repsol";
    ...
    try {
        ...
        if (resDE.ok) {
            ...
            if (dataDE && dataDE.ok && dataDE.stations) {
                stationsDE = dataDE.stations.map(st => ({
...
// ==========================================
// 5. INTERFACE ET GÉOLOCALISATION
// ==========================================
